...
class MySurfaceView extends GLSurfaceView 
{
	...
	private class SceneRenderer implements GLSurfaceView.Renderer 
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            aList.add(new RigidBody(ch,true,new Vector3f(-14f,0f,0),new Vector3f(0,0,0)));
            aList.add(new RigidBody(ch,true,new Vector3f(10f,0f,0),new Vector3f(0,0,0)));		
            aList.add(new RigidBody(ch,false,new Vector3f(-8f,0f,0),new Vector3f(12,0,0)));	        
