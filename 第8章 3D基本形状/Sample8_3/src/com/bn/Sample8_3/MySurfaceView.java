...
class MySurfaceView extends GLSurfaceView {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            mRenderer.torus.yAngle += dx * TOUCH_SCALE_FACTOR;//设置绕y轴旋转角度
            mRenderer.torus.zAngle+= dy * TOUCH_SCALE_FACTOR;//设置绕z轴旋转角度
            
            mRenderer.torusl.yAngle += dx * TOUCH_SCALE_FACTOR;//设置绕y轴旋转角度
            mRenderer.torusl.zAngle+= dy * TOUCH_SCALE_FACTOR;//设置绕z轴旋转角度
        }
