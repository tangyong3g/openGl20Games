...
class MySurfaceView extends GLSurfaceView {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            mRenderer.regular20.yAngle += dx * TOUCH_SCALE_FACTOR;//设置绕y轴旋转角度
            mRenderer.regular20.zAngle+= dy * TOUCH_SCALE_FACTOR;//设置绕z轴旋转角度
            
            mRenderer.regular20l.yAngle += dx * TOUCH_SCALE_FACTOR;//设置绕y轴旋转角度
